...
module {
    ...
    public func storeLogMessage(state: TypesModule.State, message: TypesModule.Message, data: TypesModule.Data, caller: TypesModule.Caller, time: Time.Time, maxMessageLength: Nat) {
