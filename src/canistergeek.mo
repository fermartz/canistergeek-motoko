...
module Canistergeek {
    ...
    ****************************************************************/
    ...
    public class Logger() {
        ...
        public func logMessage(message: LoggerTypesModule.Message, data: LoggerTypesModule.Data, caller: LoggerTypesModule.Caller ) : () {
            LoggerCollector.storeLogMessage(state, message, data, caller, Time.now(), LoggerTypesModule.DEFAULT_MAX_LOG_MESSAGE_LENGTH);
        };
